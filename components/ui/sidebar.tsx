...
function Sidebar({
  ...
  /** Jumlah section icon saat collapsed (untuk double sidebar) */
  ...
  return (
    <div
      ...
      style={
        multiSection
          ? ({
              '--collapsed-sections': collapsedIconSections,
            } as React.CSSProperties)
          : undefined
      }
    >
      ...
      <div
        ...
        className={cn(
          ...
          multiSection &&
            'group-data-[collapsible=icon]:!w-[calc(var(--sidebar-width-icon)*var(--collapsed-sections,1))]'
        )}
      />
      <div
        ...
        className={cn(
          ...
          multiSection &&
            'group-data-[collapsible=icon]:!w-[calc(var(--sidebar-width-icon)*var(--collapsed-sections,1)+2px)]',
          className
        )}
        {...props}
      >
