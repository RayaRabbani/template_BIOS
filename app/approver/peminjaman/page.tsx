        ...
        <div className="space-y-4 p-2 md:hidden">
          {loading
            ? Array.from({ length: 3 }).map((_, i) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-md border border-neutral-200 bg-white shadow-sm dark:border-neutral-700">
            ...
            : paginated.map(item => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="h-16 w-16 overflow-hidden rounded-md border border-neutral-200 bg-white shadow-sm dark:border-neutral-700">
                      {(() => {
                        const assets = getAssetsForItem(item);
